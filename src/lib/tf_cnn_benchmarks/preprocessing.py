...
class Cifar10ImagePreprocessor(object):
    ...
    def __init__(self,
        ...
        # size of the input layer might differ from the original size of 32 x
        # 32.
    ...
    def _distort_image(self, image):
        ...
        if self.summary_verbosity >= 3:
            tf.summary.image(
                'distorted_image', tf.expand_dims(
                    distorted_image, 0))
        return distorted_image
